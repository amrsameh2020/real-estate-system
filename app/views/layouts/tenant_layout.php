<?php
// File: app/views/layouts/tenant_layout.php

/**
 * ===================================================================
 * القالب الرئيسي لبوابة المستأجر (Tenant Layout)
 * ===================================================================
 * هذا هو الهيكل البصري لجميع صفحات بوابة المستأجر.
 * يقوم بتضمين الأجزاء المشتركة ويوفر تجربة خدمة ذاتية مخصصة للمستأجر.
 *
...
// التأكد من أن المستخدم مسجل دخوله وأنه مستأجر
if (!Auth::check() || !Auth::hasRole('Tenant')) {
...
<head>
    ...
    <title><?php e($page_title ?? 'بوابة المستأجر'); ?> - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="d-flex">
        ...
        // سيعرض هذا الملف القائمة المخصصة للمستأجر بناءً على منطق الصلاحيات
